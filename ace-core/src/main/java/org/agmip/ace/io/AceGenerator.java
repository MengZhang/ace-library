...
public class AceGenerator {
    ...
    public static void generateACEB(File dest, AceDataset set)
        ...
        bos.close(); // Doesn't do anything but look pretty
    ...
    private static void writeHeader(ByteArrayOutputStream bos) throws IOException {
        DataOutputStream dos = new DataOutputStream(bos);
        bos.write("ACEB".getBytes("UTF-8"));
        dos.writeInt(ACEB_VERSION);
        dos.writeLong(0L);
        dos.close();
    }
}
